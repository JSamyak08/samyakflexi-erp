...
/**
 * Initial Sales Quotations Dataset
 */
export const initialSalesQuotations = [
  {
    ...
    salesManager: "Samyak Jain (Sales Manager)",
    clientName: "Britannia Industries Ltd",
    ...
    cylinderTerms: "Cylinder Development Cost borne by Client @ ₹6,500/cylinder (6 Colors)",
    transportTerms: "Freight Included (FOR Pithampur Factory)",
    status: "Confirmed (Converted to OCN)",
    ocnRefNo: "SIL/OCN/26-27/089",
    convertedDate: "2026-08-03",
    items: [
      {
        id: 1,
    ...
    comments: "Urgent enquiry for monsoon festival stock rush."
  },
  {
    id: "QTN-2026-002",
    quotationNo: "SIL/QTN/26-27/002",
    revisionNo: 1,
    amendmentNo: "Rev 01",
    enquiryDate: "2026-08-02",
    estimatedDeliveryDate: "2026-08-25",
    salesManager: "Rohan Patel (Sales Manager)",
    clientName: "Procter & Gamble",
    clientAddress: "P&G Plaza, Cardinal Gracias Road, Chakala, Andheri East, Mumbai",
    clientGstin: "27AAACP9999P1Z3",
    contactPerson: "Rajesh Kulkarni",
    contactPhone: "+91 9820123456",
    contactEmail: "kulkarni.r@pg.com",
    paymentTerms: "30 Days Credit from date of receipt",
    cylinderTerms: "Cylinder Cost Free of Charge on minimum 5000 kg order volume",
    transportTerms: "Freight Extra at Actuals (Ex-Factory Pithampur)",
    ...
    items: [
      {
        id: 1,
        jobTitle: "P&G Ariel Matic 1kg Standup Pouch",
        structure: "PET 12µ / METPET 12µ / Natural LD Metallocene 40µ",
        materialFormat: "Standup Zipper Pouch Form",
        quantity: 25000,
        uom: "Pcs",
        ratePerUom: 14.50,
        printWidthMm: 1050,
    ...
    termsAndConditions: [
      "1. Standup pouch with press-to-close zipper and bottom gusset.",
      "2. Delivery within 14 working days from cylinder approval.",
      "3. Payment 30 days credit from invoice date."
    ],
    comments: "Revised quotation with 25000 Pcs volume discount."
  }
];
